...
class PartHasVehicleHasVariants(Base):
    __tablename__ = 'part_has_vehicle_has_variants'
    ...
    def __repr__(self):
        return f"<PartHasVehicleHasVariants(my_row_id={self.my_row_id}, part_has_vehicle_id={self.part_has_vehicle_id}, value={self.value})>"