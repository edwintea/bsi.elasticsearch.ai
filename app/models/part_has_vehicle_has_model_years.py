...
class PartHasVehicleHasModelYears(Base):
    __tablename__ = 'part_has_vehicle_has_model_years'
    ...
    def __repr__(self):
        return f"<PartHasVehicleHasModelYears(my_row_id={self.my_row_id}, part_has_vehicle_id={self.part_has_vehicle_id}, value={self.value})>"