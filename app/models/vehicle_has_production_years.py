...
class VehicleHasProductionYears(Base):
    __tablename__ = 'vehicle_has_production_years'
    ...
    def __repr__(self):
        return (f"<VehicleHasProductionYears(id={self.id}, vehicle_id={self.vehicle_id}, "
                f"value={self.value})>")